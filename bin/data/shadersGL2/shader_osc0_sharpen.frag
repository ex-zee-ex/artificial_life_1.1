...
uniform float osc0_sharpen_amount;
uniform float osc0_sharpen_boost;
uniform float osc0_sharpen_radius;

uniform float texmod_osc0_sharpen_amount;
uniform float texmod_osc0_sharpen_boost;
uniform float texmod_osc0_sharpen_radius;
...
void main()
{
    ...
    float sharpen_radius_mod=texmod_bright*texmod_osc0_sharpen_radius+osc0_sharpen_radius;
    ...
    original_color_hsb.z-=(osc0_sharpen_amount
                           +texmod_osc0_sharpen_amount*texmod_bright
                           )*color_sharpen_bright;
    
    //original_color_hsb.z*=(1.0+sharpen_boost+texmod_sharpen_boost*texmod_bright);
    //original_color_hsb.z*=(1.0+abs(sharpen_amount)*2.0);
    if(osc0_sharpen_amount>0){
        original_color_hsb.z*=(1.0+osc0_sharpen_amount*2.0);
    }
